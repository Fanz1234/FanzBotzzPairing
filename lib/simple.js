...
pack: "FanzBotzz", // The pack name
author: "Created By FanzOffc", // The author name
...
let stok = getRandomFile(".webp")
  ...
  title: 'FanzBotzz',body: 'Created By Fanz',previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/thumb.jpeg'),
  sourceUrl:'-'																																
...
item2.EMAIL;type=INTERNET: admin@fanzoffc.eu.org
item2.X-ABLabel:📧 Email
item3.ADR:;; Jombang;;;;
item3.X-ABADR:ac
...
item5.X-ABLabel:FanzBotzz By FanzOffc
END:VCARD`.trim()
